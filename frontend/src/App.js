    ...
    <div className="App grain min-h-screen text-foreground">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-mono text-[10px] uppercase tracking-[0.35em] text-neutral-500">
                the dialbox network
                {showDevTools ? " · dev simulator" : " · line connected"}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
                ...
                >
                  <DialogHeader>
                    ...
                    <DialogDescription className="font-mono text-[11px] text-neutral-500">
                      Experimental microphone-based DTMF detection for development keypad testing.
                    </DialogDescription>
                  </DialogHeader>
                  <DtmfTestLab />
                </DialogContent>
            ...
            <div className="hidden items-center gap-2 sm:flex">
              ...
              <span className="font-mono text-[10px] uppercase tracking-[0.3em] text-neutral-400">
                {showDevTools ? "standalone mode · network live" : "network live"}
              </span>
            </div>
          </div>
        </div>
      ...
      <main className="relative z-10 mx-auto max-w-[1500px] px-6 py-10">
        <div
          className={
            showDevTools
              ? "grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,460px)_minmax(0,1fr)]"
              : "mx-auto max-w-[460px]"
          }
        >
          <section>
