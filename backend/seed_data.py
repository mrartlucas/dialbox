...
PROGRAMS = [
    ...
    {"slug": "loveline", "name": "Chat Bae",
     "description": "AI companionship, dating, romance and relationship-themed calls.",
     "category": "adult", "menu_key": "2", "order": 2, "enabled": False,
    ...
    {"slug": "adventure", "name": "Dial 4 Adventure",
     "description": "Audio adventures: talk to characters, use the keypad to decide.",
     "category": "all_ages", "menu_key": "4", "order": 4, "enabled": False,
     "coming_soon": True, "has_personas": False, "interaction": "menu"},
    {"slug": "pickup", "name": "Smooth Operator",
     "description": "Pickup lines, flirting games and confidence practice.",
     "category": "all_ages", "menu_key": "5", "order": 5, "enabled": False,
     "coming_soon": True, "has_personas": False, "interaction": "menu"},
